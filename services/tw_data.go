...
func GetTwData(start_date ,end_date string ,limit int)error{
	...
	dataUrl:= fmt.Sprintf( "https://api.twelvedata.com/time_series?symbol=AAPL,TSLA&interval=1min&start_date=%s&end_date=%s&apikey=%s&source=docs&outputsize=%d",start_date ,end_date,"21cad25580b74ba3a0a2ba9be29057bb",limit)
